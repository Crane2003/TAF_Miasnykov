...
public class DriverManager
{
    ...
    public static void InitDriver(BrowserType browserType, bool headless = true)
    {
        if (_driver.Value == null)
        {
            _logger.Information("Initializing WebDriver for browser: {BrowserType} (Headless: {Headless})", browserType, headless);
